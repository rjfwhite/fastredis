...
public class RedisSubscriber
{
    ...
    public IReadOnlySet<string> ActiveSubscriptions => _activeSubscriptions;
    public IReadOnlySet<string> PendingSubscriptions => _pendingSubscriptions;
